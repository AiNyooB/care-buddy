...
export function Settings({ isStandalone = false }: SettingsProps) {
  ...
  return (
    <div className="flex w-full flex-col gap-4">
      ...
      <div className="space-y-1 rounded-lg border border-border ring-0 bg-card p-4 shadow-sm">
        ...
        <div className="flex items-center justify-between py-2">
          <span className="text-sm font-medium text-muted-foreground/70">{t('settings.advanced')}</span>
        </div>
