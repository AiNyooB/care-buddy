  ...
  return (
    <div className="text-center animate-[lockScaleIn_0.35s_ease]">
      ...
      <div className="text-left bg-white/10 rounded-xl p-4 mb-5">
        ...
        <div className="text-type-section-title text-white/80 leading-relaxed">{exercise.instructions}</div>
      </div>

      {exercise.repetitions && (
        <div className="flex items-center justify-center gap-2 mb-3 text-lg font-semibold">
          <span className="text-white/70 text-type-section-title">{t('exercise.repetitions')}:</span>
          <span className="text-success text-xl">{exercise.repetitions}</span>
        </div>
      )}
      {exercise.holdTime && (
        <div className="flex items-center justify-center gap-2 mb-3 text-lg font-semibold">
          <span className="text-white/70 text-type-section-title">{t('exercise.holdTime')}:</span>
