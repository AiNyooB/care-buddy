...
const zhCN = {
  ...
  settings: {
    ...
    strictModeWarningDesc: '严格模式下，锁屏期间无法中途退出。必须完成设定的运动或等待倒计时结束。此设置会立即生效。',
    ...
    mergeReminders: '提醒合并',
    mergeRemindersDesc: '即将触发的提醒会与当前锁屏合并处理（分钟）',
    advanced: '高级设置',
    taskManagement: '提醒管理',
...
const enUS = {
  ...
  settings: {
    ...
    strictModeWarningDesc: 'In strict mode, you cannot exit mid-lock. You must complete configured exercises or wait for the countdown to end. This setting takes effect immediately.',
    ...
    mergeReminders: 'Merge reminders',
    mergeRemindersDesc: 'Reminders about to trigger will be merged with the current lock screen (minutes)',
    advanced: 'Advanced',
